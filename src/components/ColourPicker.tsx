...
export default function ColourPicker({
  ...
  return (
    <label
      className={`block ${embedded ? "" : "rounded-2xl border border-[var(--dmi-border)] bg-[var(--dmi-surface-soft)] p-3"} ${className}`}
    >
      <span className={embedded ? "sr-only" : "mb-2 block text-sm font-semibold text-[var(--text-primary)]"}>
        {label}
      </span>
